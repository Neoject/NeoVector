NV.ready(() => {
    ...
    createApp({
        ...
        methods: {
            ...
            handleNavigationClick(event, targetId) {
            ...
            async openVirtualPage(slug, options = {}) {
                ...
                try {
                    ...
                    if (page.meta_title) {
                        ...
                        document.title = page.title + ' - Aeternum';
                    }
                    ...
                    console.error('Error opening virtual page:', error);
                    this.currentVirtualPage = null;
            ...
            goHome(options = {}) {
                ...
                this.currentProduct = null;
                this.headerNavigation.other = [];
                document.title = 'Aeternum - Премиальные ремни для часов';
            ...
            async checkVirtualPage() {
                ...
                const page = await this.loadVirtualPage(slug);
                if (page) {
                    this.currentVirtualPage = page;
                    this.virtualPageError = null;
                    this.currentProduct = null;
                ...
                this.currentProduct = null;
                this.virtualPageError = 'Страница не найдена';
                document.title = 'Страница не найдена - Aeternum';
                this.$nextTick(() => this.$forceUpdate());
            },
            ...
            getActualLink(promo) {
                ...
                return this.getButtonLink({ linkType: promo.linkType || 'url', link: promo.link, target: promo.link });
            },
            ...
            handleButtonClick(event, button) {
                ...
                if (button.linkType === 'page') {
                    ...
                    this.openVirtualPage(normalizedTarget, { updateHistory: true, scrollToTop: true }).then((page) => {
                        ...
                        this.virtualPageError = 'Ошибка загрузки страницы';
                        document.title = 'Ошибка - Aeternum';
                    });
                } else if (button.linkType === 'section') {
                    event.preventDefault();
            ...
            openProductPage(product) {
                ...
                this.$nextTick(() => {
                    ...
                    if (this.currentProduct.meta_title) {
                        ...
                        document.title = this.currentProduct.name + ' - Aeternum';
                    }
